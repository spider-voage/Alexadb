...
if (!JWT_SECRET || JWT_SECRET.length < 32) { console.error('FATAL: JWT_SECRET too short'); process.exit(1); }
if (!JWT_REFRESH_SECRET || JWT_REFRESH_SECRET.length < 32) { console.error('FATAL: JWT_REFRESH_SECRET too short'); process.exit(1); }
